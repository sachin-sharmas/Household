...
export default function DashboardPage() {
  ...
  return (
    <AppShell
      ...
      subtitle="Add items, assign who's bringing them, and track delivery status."
      headerAction={
        <button
    ...
    >
      ...
      <ItemFilterToolbar
        ...
        searchPlaceholder="Search grocery or food item"
      ...
      <ItemListSection
        ...
        emptyMessage='No items yet. Click "Add Item" to create your first item.'
        onAddItem={openAddForm}
      />
    </AppShell>
  );
